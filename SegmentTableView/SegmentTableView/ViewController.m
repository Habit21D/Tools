...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (contentY > HEAD_HEIGHT) {
        ...
        self.headView.frame = CGRectMake(SCREEN_WIDTH * contentY / HEAD_HEIGHT /2, 0, SCREEN_WIDTH * (HEAD_HEIGHT - contentY)/HEAD_HEIGHT, HEAD_HEIGHT - contentY);
    }
